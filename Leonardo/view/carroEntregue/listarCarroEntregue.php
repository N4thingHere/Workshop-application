<?php 
    include_once 'C:\XAMPP\htdocs\Matheus\BLL\bllCarroEntregue.php';
    ...
    <header id="header">
        ...
        ?>
          <tr>
            <td><?php echo $p->getIdCarroEntregue(); ?></td>
            <td><?php echo $p->getPlacaCarroEntregue(); ?></td>
            <td><?php echo $p->getFinalPlacaCarroEntregue(); ?></td>
            <td><?php echo $p->getNomeProprietarioCarroEntregue(); ?></td>
          </tr>
          <?php 
                }
            ?>
