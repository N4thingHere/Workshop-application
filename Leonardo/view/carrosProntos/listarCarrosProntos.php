<?php
include_once 'C:\XAMPP\htdocs\Workshop-application\Leonardo\BLL\bllCarroPronto.php';

use BLL\bllCarrosProntos;

$bll = new \BLL\bllCarrosProntos();
$pronto = $bll->Select();
?>
    ...
    <header id="header">
        ...
        <?php
            foreach($pronto as $p) {
                ?>
            <tr>
            <td><?php echo $p->getIdCarroPronto(); ?></td>

            <td><?php echo $p->getPlacaCarroPronto(); ?></td>

            <td><?php echo $p->getFinalPlacaCarroPronto(); ?></td>

            <td><?php echo $p->getNomeProprietarioCarroPronto(); ?></td>
            </tr>
        <?php 
            }
        ?>
