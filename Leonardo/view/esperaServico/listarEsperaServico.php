<?php
include_once 'C:\XAMPP\htdocs\Workshop-application\Leonardo\BLL\bllEsperaServico.php';

use BLL\bllEsperaServico;

$bll = new \BLL\bllEsperaServico();
$espera = $bll->Select();
?>
...
<!DOCTYPE html>
    ...
    <header id="header">
        ...
        <tbody>
        <?php
            foreach($espera as $esp) {
                ?>
            <tr>
            <td><?php echo $esp->getIdEsperaServico(); ?></td>

            <td><?php echo $esp->getPlacaEsperaServico(); ?></td>

            <td><?php echo $esp->getFinalPlacaEspera(); ?></td>

            <td><?php echo $esp->getNomeProprietarioEspera(); ?></td>
            </tr>
        <?php 
            }
        ?>
